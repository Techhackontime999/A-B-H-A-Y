              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <Card className="bg-card/50 border-white/5 hover:border-accent/30 transition-all group">
                  <CardContent className="pt-8 pb-10 px-8 flex flex-col gap-6">
                    ...
                    <p className="text-muted-foreground leading-relaxed">
                      No email, no phone, no KYC. We use cryptographic signatures via Ethereum/Solana wallets to verify you exist without knowing who you are.
                    </p>
                  </CardContent>
                </Card>
              ...
              <div className="flex flex-col lg:flex-row gap-16 items-center">
                <div className="flex-1 space-y-8">
                  ...
                  <div className="space-y-6">
                    <div className="flex gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-muted-foreground">Connect any EVM or Solana wallet to generate a decentralized ID (DID) instantly.</p>
                      </div>
                    </div>
                    <div className="flex gap-4">
                  ...
                  <Button variant="link" className="text-accent p-0 font-bold gap-2">
                    Learn about our consensus mechanism <ArrowRight className="h-4 w-4" />
                  </Button>
                </div>
